package br.com.cifras.shared.config;
...
@RegisterForReflection(targets = {
    ...
    br.com.cifras.song.domain.LyricsStructure.class,
    br.com.cifras.song.domain.MusicalKey.class,
    br.com.cifras.song.domain.Line.class,
    br.com.cifras.song.domain.ChordPosition.class,
    br.com.cifras.song.domain.Section.class,
    br.com.cifras.song.domain.EnharmonicConvention.class,
