...
export const UserMenu: React.FC<UserMenuProps> = ({ direction = 'down' }) => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className={`absolute w-48 bg-bg-card rounded-md shadow-lg py-1 border border-border-main z-50 ${direction === 'up' ? 'bottom-full mb-2 left-0' : 'top-full mt-2 right-0'}`}>
